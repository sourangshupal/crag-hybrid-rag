...
flowchart TD
    ...
    subgraph AWS["AWS — us-east-1"]
        ECR["Amazon ECR\ncrag-hybrid-rag\n:SHA  :latest"]
        S3B["Amazon S3\nelasticbeanstalk-us-east-1-ACCOUNT_ID\n/crag-hybrid-rag/<version>.zip"]
        EB["Elastic Beanstalk\ncrag-hybrid-rag / crag-hybrid-prod\nt3.large · Amazon Linux 2 · Docker"]
        EC2["EC2 Instance\nDocker container\nport 8000"]
...
sequenceDiagram
    ...
    GH->>S3: aws s3 cp deploy.zip s3://elasticbeanstalk-.../crag-hybrid-rag/<version>.zip
